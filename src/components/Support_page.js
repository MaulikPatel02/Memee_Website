...
import red_message from '../images/Feedback_page_img/red_message.png';
          ...
          <div className="Winner_profile_section">
            ...
            <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" id="dmenu">
                      <li id="dmenu-2">Abuse <img src={red_message}></img> </li>
                      <li id="dmenu-2">Payment</li>
                      <li id="dmenu-2">Image <img src={red_message}></img></li>
                      <li id="dmenu-2">Profile <img src={red_message}></img></li>
                      <li id="dmenu-2">Tournament <img src={red_message}></img></li>
                      <li id="dmenu-2">Coins</li>
                      <li id="dmenu-2">Plagiarism <img src={red_message}></img></li>
                    </ul>
                  </div>
            </div>
